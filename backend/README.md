...
## Project Structure
    ...
    ├── figma_app_test_dev_23634  # Django project configurations
...
1. Clone this repo and `cd figma_app_test_dev_23634`
...
2. Clone this repo and `cd figma_app_test_dev_23634`
